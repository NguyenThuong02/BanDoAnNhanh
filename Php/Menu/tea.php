...
<body>
                    ...
                    <nav class="category">
                        ...
                        <ul class="category-list">
                            ...
                            <li class="category-item category-item--active">
                                <a href="tea.php" class="category-item__link">Tea</a>
                            </li>
                            <li class="category-item">
                                <a href="MenuCake.php" class="category-item__link">Cake</a>
                            </li>
                        </ul>
                    </nav>
                </div>
                        ...
                        <div id="all">
                            <div class="grid__row">
                                <div class="grid__row-2">
                                    <?php
                                    $select_product = mysqli_query($conn, "SELECT * FROM `sanpham` WHERE loai_sp = 'Trà'") or die('query failed');
                                            ...
                                            <form action="" method="post">
                                                ...
                                                <div class="home-product-item product">
                                                    ...
                                                    <div class="home-product-item__price">
                                                        <span class="home-product-item__new-price"><?php echo $fetch_product['gia_sp']; ?></span> <br>
    ...
    <footer>
        <section class="footer">
            <div class="box-container">
                ...
                <div class="box">
                    ...
                    <<a href="#" class="links">
                        ...
                        <a href="#" class="links">
                            <i class="fas fa-envelope"></i> Thesky@gmail.com
                        </a>
            ...
            <div class="credit">
                <span> Team 10 </span> | 2311ECIT0731
            </div>
        </section>
    </footer>
    <!-- Footer end -->
