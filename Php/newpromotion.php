    ...
    <ul id="list-products">
      <div class="list">
        <div class="item">
          ...
          <div class="name">Khai trương Let’s it - Nhận quà không ít</div>
          <div class="desc">
            <p>Thời gian diễn ra: 9h ngày 28/02/2023 </p>
          </div>
        </div>
        <div class="item">
          <img src="../images/Index/New _ promotion/blog-2.webp" alt="">
          <div class="name">Flashsale 08/03 năm nay</div>
          <div class="desc">Từ ngày 01/03 đến ngày 08/03/2023</div>
        </div>
        <div class="item">
          <img src="../images/Index/New _ promotion/blog-3.webp" alt="">
          <div class="name">Siêu Tiệc Bất Ngờ Năm Nay</div>
          <div class="desc">Từ ngày 01/12 đến ngày 12/12/2023
          </div>
        </div>
        <div class="item">
          <img src="../images/New_Promotions/Blue Modern Ice Tea Facebook Post.jpg" alt="">
          <div class="name">Ra mắt sản phẩm mới</div>
          <div class="desc">Từ ngày 30/04 đến ngày 9/12/2023<br>
